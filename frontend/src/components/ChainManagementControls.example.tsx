...
export function LargeClassExample() {
  ...
  const [chains] = useState<Chain[]>(
    Array.from({ length: 10 }, (_, i) => ({
      ...
      index: 0,
      state: ChainState.ACTIVE,
      lastHolder: `attendee-${String(i + 1).padStart(3, '0')}`,
