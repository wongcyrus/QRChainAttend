...
describe('StudentSessionView', () => {
  ...
  describe('Rendering', () => {
    test('should render loading state initially', () => {
      render(
        <StudentSessionView sessionId="session-123" attendeeId="attendee-123" />
      );
  ...
  describe('Session Status', () => {
    ...
    test('should display attendee attendance status', async () => {
      render(
        <StudentSessionView sessionId="session-123" attendeeId="attendee-123" />
      );
  ...
  describe('QR Display Integration', () => {
    test('should display holder QR when attendee becomes holder', async () => {
      const activeSession = {
        ...mockSession,
        startAt: new Date(Date.now() - 1800000).toISOString(),
      };
      ...
      // Simulate successful scan that makes attendee-123 the holder
  ...
  describe('Instructions', () => {
    test('should show instructions when attendee has not marked entry', async () => {
    ...
    test('should not show instructions when attendee has marked entry', async () => {
      const activeSession = {
        ...mockSession,
        startAt: new Date(Date.now() - 1800000).toISOString(),
      };
